...
public class SlideDeleteRecyclerView extends RecyclerView {
    private static final String TAG = "SlideDeleteRecyclerView";
    ...
    public SlideDeleteRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideDeleteRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mPosition != INVALID_POSITION) {
                    ...
                    if (mFlingView.getChildCount() == 4) {
                        mMenuViewWidth = mFlingView.getChildAt(3).getWidth();
                    } else {
